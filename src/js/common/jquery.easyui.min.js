...
},beforePageText:"页数",afterPageText:"of {pages}",displayMsg:"显示 {from} 到 {to} 中的 {total} 组项目",nav:{first:{iconCls:"pagination-first",handler:function(){
...
},message:"请填写一个正确的邮箱地址."},url:{validator:function(_46f){
...
},message:"请填写一串数字在 {0} 位数"},remote:{validator:function(_472,_473){
var data={};
data[_473[1]]=_472;
...
_9f6(this,q);
}},currentText:"今天",closeText:"关闭",okText:"Ok",buttons:[{text:function(_a0b){
