import template from "./purgroupInformationManagerAdd.html";
import "./purgroupInformationManagerAdd.scss";
import { CommonComponentBox } from "../../../common/global_val";

const purgroupInformationManagerAddComponent = {
    template : template,
    bindings : {
        resolve:'<',
        close: '&',
...
export default purgroupInformationManagerAddComponent;
